...
const STARS = [
  [4, 18, 1.4, 0], [11, 62, 1, 1.2], [17, 33, 1.8, 2.4], [23, 78, 1, 0.6],
  [29, 12, 1.2, 3.1], [34, 51, 1.6, 1.8], [41, 27, 1, 2.2], [46, 71, 1.3, 0.4],
  [52, 8, 1.7, 2.8], [58, 44, 1, 1.1], [63, 86, 1.4, 3.6], [69, 21, 1.1, 0.9],
  [74, 58, 1.9, 2.1], [79, 37, 1, 1.5], [84, 74, 1.3, 3.3], [88, 15, 1.6, 0.2],
  [92, 49, 1, 2.6], [96, 82, 1.2, 1.7], [7, 91, 1.1, 2.9], [37, 95, 1.5, 0.8],
  [66, 5, 1, 1.9], [21, 46, 1, 3.4], [55, 66, 1.2, 0.5], [86, 92, 1.4, 2.3],
] as const;

type DepthLayer = "far" | "mid" | "near";

function getDepthProps(i: number, size: number): { layer: DepthLayer; scale: number; opacity: number; duration: number } {

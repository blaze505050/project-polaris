...
export function TransparencyModal({ isOpen, onClose }: TransparencyModalProps) {
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className="relative w-full max-w-3xl max-h-[90vh] overflow-y-auto rounded-2xl border border-border bg-card p-6 md:p-8 shadow-2xl text-foreground font-sans space-y-6"
      ...
      >
        ...
        <div className="flex items-start justify-between border-b border-border pb-4">
          ...
          <button
            type="button"
            onClick={onClose}
            aria-label="Close institutional audit dialog"
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="rounded-xl border border-border bg-surface p-4 md:p-5 space-y-2">
            <div className="flex items-center gap-2 text-emerald-500 dark:text-emerald-400 font-semibold text-sm font-ui">
          ...
          <div className="rounded-xl border border-border bg-surface p-4 md:p-5 space-y-2">
            <div className="flex items-center gap-2 text-amber-600 dark:text-amber-300 font-semibold text-sm font-ui">
        ...
        <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-4 md:p-5 space-y-2 font-mono text-xs">
          ...
          <ul className="grid sm:grid-cols-2 gap-2 text-muted-foreground text-[11px] pt-1">
            <li className="flex items-center gap-1.5">
              <CheckCircle2 className="size-3.5 text-emerald-500 shrink-0" />
              <span className="text-foreground">Strict Origin postMessage Validation</span>
            </li>
            <li className="flex items-center gap-1.5">
              <CheckCircle2 className="size-3.5 text-emerald-500 shrink-0" />
              <span className="text-foreground">Restricted Iframe Sandbox Flags</span>
            </li>
            <li className="flex items-center gap-1.5">
              <CheckCircle2 className="size-3.5 text-emerald-500 shrink-0" />
              <span className="text-foreground">Deterministic Artifact Regex Sanitization</span>
            </li>
            <li className="flex items-center gap-1.5">
              <CheckCircle2 className="size-3.5 text-emerald-500 shrink-0" />
              <span className="text-foreground">Zero Third-Party AI Model Training</span>
            </li>
          </ul>
        </div>
        ...
        <div className="flex items-center justify-between flex-wrap gap-3 pt-2 border-t border-border">
          ...
          <div className="flex items-center gap-3">
            <Button
              ...
              size="sm"
              onClick={onClose}
              className="rounded-lg text-foreground hover:bg-surface-2"
            >
              Close Notice
            </Button>
            <Button

...
export function TransparencyModal({ isOpen, onClose }: TransparencyModalProps) {
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-3xl max-h-[90vh] overflow-y-auto rounded-2xl border border-primary/30 bg-slate-950/95 p-6 md:p-8 shadow-2xl text-white font-sans space-y-6"
      ...
      >
        ...
        <div className="flex items-start justify-between border-b border-white/10 pb-4">
          <div className="space-y-1">
            ...
            <h2 id="transparency-modal-title" className="text-xl md:text-2xl font-display font-bold text-white tracking-tight">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="rounded-xl border border-white/10 bg-slate-900/60 p-4 space-y-2">
            ...
            <p className="text-xs text-slate-300 leading-relaxed">
              AeroForge AI is an official, non-commercial engineering research laboratory built and maintained by <strong>Project Polaris</strong>. It is designed to close the engineering tools access gap for students and self-taught builders worldwide.
            </p>
          </div>

          {/* Pillar 2: Data Sovereignty */}
          <div className="rounded-xl border border-white/10 bg-slate-900/60 p-4 space-y-2">
            <div className="flex items-center gap-2 text-emerald-400 font-semibold text-sm font-ui">
              <Lock className="size-4" />
              <span>2. 100% Client-Side Sovereignty</span>
            </div>
            <p className="text-xs text-slate-300 leading-relaxed">
              All CAD geometries (<code>.STL</code>, <code>.STEP</code>), finite element meshes, and airfoil parameters execute entirely within your local browser sandbox. Zero telemetry or user engineering IP is sold or harvested.
            </p>
          </div>

          {/* Pillar 3: Mathematical Transparency */}
          <div className="rounded-xl border border-white/10 bg-slate-900/60 p-4 space-y-2">
            <div className="flex items-center gap-2 text-sky-400 font-semibold text-sm font-ui">
          ...
          <div className="rounded-xl border border-white/10 bg-slate-900/60 p-4 space-y-2">
            <div className="flex items-center gap-2 text-amber-400 font-semibold text-sm font-ui">
        ...
        <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-4 space-y-2 font-mono text-xs">
          <div className="flex items-center gap-2 text-emerald-400 font-bold">
            <FileCheck2 className="size-4 shrink-0" />
            <span>SECURITY AUDIT PROTOCOL COMPLIANCE:</span>
          </div>
          <ul className="grid sm:grid-cols-2 gap-2 text-slate-300 text-[11px] pt-1">
        ...
        <div className="flex items-center justify-between flex-wrap gap-3 pt-2 border-t border-white/10">
          ...
          <div className="flex items-center gap-3">
            <Button
              ...
              size="sm"
              onClick={onClose}
              className="rounded-lg border-white/15 bg-white/5 hover:bg-white/10 text-white"
            >
              Close Notice
            </Button>
            <Button

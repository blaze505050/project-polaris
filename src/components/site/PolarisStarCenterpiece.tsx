...
export function PolarisStarCenterpiece() {
  return (
    <div className="relative w-full max-w-lg mx-auto lg:max-w-none">
      {/* Main Card Frame */}
      <div className="relative rounded-2xl border border-border bg-card p-5 shadow-lg overflow-hidden transition-colors hover:border-border-strong">
        {/* Header Ribbon inside card */}
        <div className="relative z-10 flex items-center justify-between pb-3.5 mb-3.5 border-b border-border">
          ...
          <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full border border-emerald-500/30 bg-emerald-500/10 text-[10px] font-mono text-emerald-600 dark:text-emerald-400 font-medium">
        ...
        <div className="relative z-10 rounded-xl overflow-hidden border border-border shadow-sm">
          <picture>
          ...
          <div className="absolute bottom-3 left-3 right-3 p-2.5 rounded-lg bg-background/90 dark:bg-black/75 backdrop-blur-sm border border-border">
            <p className="text-xs text-foreground text-center font-medium font-sans leading-snug">

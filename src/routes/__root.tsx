      ...
      <div className="max-w-xl w-full text-center relative z-10 space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs sm:text-sm text-muted-foreground max-w-md mx-auto leading-relaxed font-sans">
            The orbital trajectory or page you are looking for has decayed or does not exist. Let's
            recalculate your state vectors.
          </p>
        </div>
        ...
        <div className="pt-4 flex items-center justify-center gap-3">
          <Button
            asChild
            size="default"
            className="h-10 px-6 font-mono text-xs bg-primary text-primary-foreground font-bold shadow-sm hover:bg-primary/90"
          >
            <Link to="/">
          ...
          <Button
            ...
            variant="outline"
            size="default"
            className="h-10 px-5 font-mono text-xs border-border hover:border-primary/40"
          >
    ...
    <div className="flex min-h-[75vh] items-center justify-center px-4 py-12">
      <div className="max-w-lg w-full text-center rounded-xl border border-destructive/30 bg-card p-8 md:p-10 shadow-lg">
        ...
        <p className="mt-3 text-xs text-muted-foreground leading-relaxed font-sans">
          We encountered an unexpected state while initializing this component. You can reload this
          state or return to the main hub.
        </p>
        ...
        {import.meta.env.DEV && error?.message ? (
          <div className="mt-5 text-left p-3.5 rounded-lg bg-background border border-border text-xs font-mono text-muted-foreground overflow-auto max-h-36">
            <span className="text-destructive font-semibold">Debug Message:</span> {error.message}
          </div>
        ) : (
          <div className="mt-5 text-left p-3.5 rounded-lg bg-background border border-border text-xs font-mono text-muted-foreground">
            <span className="text-primary font-semibold">Incident Ref:</span> POLARIS-
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3 font-mono text-xs">
          ...
          <Button
            ...
            variant="outline"
            size="sm"
            className="h-9 px-5 border-border hover:border-primary/40"
          >
            <a href="/">Go to Home</a>
          </Button>
        </div>

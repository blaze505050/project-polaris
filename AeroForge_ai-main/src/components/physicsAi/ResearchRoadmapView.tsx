      ...
      <div className="bg-[#0A1020] border border-cyan-500/20 rounded-xl p-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          ...
          <h2 className="text-xl font-extrabold font-mono text-white">
            AeroForge Physics AI Development Roadmap
          </h2>
          <p className="text-xs text-white/60 mt-1 max-w-3xl leading-relaxed">
            Transparent 6-phase roadmap outlining the progression from lightweight surrogate
            prototypes to future multi-physics neural foundation operators.
          </p>
        </div>
      </div>
          ...
          >
            <div>
              <div className="flex items-center justify-between mb-3 font-mono">
                ...
                <span
                  className={`px-2 py-0.5 rounded border text-[9px] font-bold ${ph.statusColor}`}
                >
                  {ph.status}
                </span>
              </div>
      ...
      <div className="bg-[#0A1020] border border-purple-500/30 rounded-xl p-6 shadow-2xl space-y-6">
        <div className="border-b border-white/10 pb-4">
          ...
          <p className="text-xs text-white/60 max-w-3xl leading-relaxed">
            Conceptual multi-modal architecture mapping raw CAD geometry tokens, unstructured mesh
            graphs, and physical boundary conditions into unified spatial-spectral neural
            representations.
          </p>
        </div>

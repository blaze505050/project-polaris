...
import { computeRocketAscent, type LaunchAscentResult, type RocketStageConfig } from '@/services/physicsEngine';
...
const ROCKET_PRESETS: Array<{ name: string; payload: number; targetAlt: number; stages: RocketStageConfig[] }> = [
  {
    name: 'SpaceX Falcon 9 (Full Thrust)',
    payload: 15600, // kg to LEO
    targetAlt: 400,
    stages: [
      { name: 'Stage 1 (9x Merlin 1D)', dryMass: 22200, propellantMass: 418700, isp: 311, thrust: 7607000, burnTime: 162 },
      { name: 'Stage 2 (1x Merlin Vacuum)', dryMass: 4000, propellantMass: 107500, isp: 348, thrust: 981000, burnTime: 397 },
    ],
  },
  {
    name: 'NASA Saturn V',
    ...
    targetAlt: 185,
    stages: [
      { name: 'S-IC (5x F-1)', dryMass: 130000, propellantMass: 2160000, isp: 263, thrust: 35100000, burnTime: 168 },
      { name: 'S-II (5x J-2)', dryMass: 36000, propellantMass: 456000, isp: 421, thrust: 5000000, burnTime: 360 },
      { name: 'S-IVB (1x J-2)', dryMass: 13500, propellantMass: 106000, isp: 421, thrust: 1000000, burnTime: 165 },
    ],
  },
  {
    ...
    targetAlt: 500,
    stages: [
      { name: 'Stage 1 (9x Rutherford)', dryMass: 950, propellantMass: 9250, isp: 311, thrust: 192000, burnTime: 150 },
      { name: 'Stage 2 (1x Rutherford Vac)', dryMass: 250, propellantMass: 2100, isp: 343, thrust: 22000, burnTime: 300 },
    ],
  },
];
...
const ASCENT_METADATA: SimulationMetadata = {
  ...
  unitsTable: [
    { symbol: 'ΔV', name: 'Total Velocity Increment', unit: 'm/s', description: 'Ideal delta-v capacity calculated via Tsiolkovsky equation' },
    { symbol: 'q_dyn', name: 'Dynamic Pressure', unit: 'kPa', description: 'Kinetic pressure exerted by atmospheric air stream' },
    { symbol: 'Isp', name: 'Specific Impulse', unit: 'seconds', description: 'Engine efficiency (thrust per weight flow rate of propellant)' },
    { symbol: 'm_payload', name: 'Payload Mass', unit: 'kg', description: 'Mass of orbital payload deliverable to target altitude' },
  ],
  references: [
    ...
    <div className="min-h-screen bg-[#060B18] text-white">
      ...
      <div className="max-w-[120rem] mx-auto px-4 md:px-[4%] py-6 space-y-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-white/50 font-mono">Tsiolkovsky Rocket Equation · Gravity turn trajectory · Max-Q dynamic pressure</p>
            </div>
          </div>
            ...
            <div className="rounded-xl bg-white/[0.03] border border-white/10 p-4" style={{ backdropFilter: 'blur(20px)' }}>
              ...
              <div className="mb-3">
                <div className="flex justify-between text-xs mb-1">
                  ...
                  <span className="font-mono text-amber-400">{payloadMass.toLocaleString()} kg</span>
                </div>
                <input type="range" min={50} max={150000} step={100} value={payloadMass}
              ...
              <div>
                ...
                <input type="range" min={150} max={1000} step={10} value={targetAltKm}
            ...
            <div className="rounded-xl bg-white/[0.03] border border-white/10 p-4" style={{ backdropFilter: 'blur(20px)' }}>
              ...
              <div className="space-y-2 font-mono text-xs">
                <div className="flex justify-between border-b border-white/5 py-1">
                  ...
                  <span className="text-cyan-400 font-bold">{(result.totalDeltaV / 1000).toFixed(2)} km/s</span>
                </div>
                <div className="flex justify-between border-b border-white/5 py-1">
                ...
                <div className="flex justify-between border-b border-white/5 py-1">
                  ...
                  <span className="text-white">{(result.finalVelocity / 1000).toFixed(2)} km/s</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <ExperimentHistoryLogger
          ...
          currentOutputs={{ totalDeltaV_km_s: result.totalDeltaV / 1000, maxQ_kPa: result.maxQ, orbitReached: result.orbitReached ? 'SUCCESS' : 'UNDERPOWERED' }}
        />

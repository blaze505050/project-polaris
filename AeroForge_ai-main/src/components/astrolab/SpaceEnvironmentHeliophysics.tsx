  ...
  unitsTable: [
    {
      ...
      unit: "dimensionless",
      description: "Quasi-logarithmic 3-hour geomagnetic activity scale (0 to 9)",
    },
    {
      symbol: "SEU",
      name: "Single Event Upset Rate",
      unit: "bit-flips/day",
      description: "Predicted cosmic ray & proton induced memory bit flips",
    },
    {
      symbol: "v_sw",
      name: "Solar Wind Velocity",
      unit: "km/s",
      description: "Bulk speed of solar plasma stream at 1 AU",
    },
    {
      symbol: "D",
      name: "Ionizing Radiation Dose",
      unit: "mrad/day",
      description: "Cumulative absorbed radiation dose",
    },
  ],
  references: [
...
export default function SpaceEnvironmentHeliophysics() {
  ...
  useEffect(() => {
    ...
    const saaGrad = ctx.createRadialGradient(
      (saaX1 + saaX2) / 2,
      (saaY1 + saaY2) / 2,
      10,
      (saaX1 + saaX2) / 2,
    ...
    <div className="min-h-screen bg-[#060B18] text-white">
      ...
      <div className="max-w-[120rem] mx-auto px-4 md:px-[4%] py-6 space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-white/50 font-mono">
                SAA radiation belt mapping · SEU prediction · Autonomous safe-mode fault manager
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            <div>
              ...
              <span className="text-sm font-bold font-mono">
                {weatherStatus.saaIntersection ? "INSIDE HAZARD ZONE" : "Nominal Orbit"}
              </span>
            </div>
          ...
          <div
            className={`p-4 rounded-xl border flex items-center justify-between ${
              weatherStatus.safeModeTriggered
          ...
          >
            <div>
              ...
              <span className="text-sm font-bold font-mono">
                {weatherStatus.safeModeTriggered ? "AUTONOMOUS SAFE MODE" : "Normal Operation"}
              </span>
            </div>
          ...
          <div className="p-4 rounded-xl bg-white/[0.03] border border-white/10 flex items-center justify-between text-white/60">
            <div>
              ...
              <span className="text-sm font-bold font-mono text-amber-400">
                Class {weatherStatus.xrayFluxClass} Flare
              </span>
            </div>
            ...
            >
              ...
              <label className="flex items-center justify-between text-xs text-white/60 cursor-pointer pt-2 border-t border-white/5">
                ...
                <input
                  type="checkbox"
                  checked={cmeActive}
                  onChange={(e) => setCmeActive(e.target.checked)}
              ...
              <div className="space-y-2 font-mono text-xs">
                <div className="flex justify-between border-b border-white/5 py-1">
                  ...
                  <span className="text-amber-400 font-bold">
                    {weatherStatus.solarWindSpeed} km/s
                  </span>
                </div>
                <div className="flex justify-between border-b border-white/5 py-1">
                  <span className="text-white/40">SEU Bit Flip Rate</span>
                  <span
                    className={`font-bold ${weatherStatus.seuRatePerDay > 1 ? "text-red-400" : "text-emerald-400"}`}
                  >
        ...
        <ExperimentHistoryLogger
          ...
          currentOutputs={{
            saaIntersection: weatherStatus.saaIntersection ? "INSIDE_SAA" : "NOMINAL",
            seuRatePerDay: weatherStatus.seuRatePerDay,
            safeModeTriggered: weatherStatus.safeModeTriggered ? "SAFE_MODE_ACTIVE" : "NOMINAL",
          }}
        />

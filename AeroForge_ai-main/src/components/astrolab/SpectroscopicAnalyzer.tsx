...
const TARGET_PRESETS: Array<
  "G-star (Sun)" | "O-star" | "M-dwarf" | "Quasar" | "Exoplanet Atmosphere"
> = ["G-star (Sun)", "O-star", "M-dwarf", "Quasar", "Exoplanet Atmosphere"];
  ...
  unitsTable: [
    {
      ...
      name: "Wavelength",
      unit: "nm",
      description: "Light wavelength in nanometers (1 nm = 10 Å)",
    },
    {
      symbol: "z",
      name: "Redshift Parameter",
      unit: "dimensionless",
      description: "Fractional shift in wavelength",
    },
    {
      symbol: "v_rad",
      name: "Radial Velocity",
      unit: "km/s",
      description: "Velocity of astronomical target relative to observer along line of sight",
    },
    {
      symbol: "SNR",
    ...
    <div className="min-h-screen bg-[#060B18] text-white">
      ...
      <div className="max-w-[120rem] mx-auto px-4 md:px-[4%] py-6 space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-white/50 font-mono">
                1D spectrum analysis · Relativistic Doppler shift · Balmer & Fraunhofer line
                matching
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <label className="flex items-center justify-between text-xs text-white/60 cursor-pointer pt-2 border-t border-white/5">
                ...
                <input
                  type="checkbox"
                  checked={showLineOverlays}
                  onChange={(e) => setShowLineOverlays(e.target.checked)}
              ...
              <div className="space-y-2 mb-3">
                <div>
                  ...
                  <input
                    ...
                    step="0.01"
                    value={obsWavelength}
                    onChange={(e) => setObsWavelength(Number(e.target.value))}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setRestWavelength(Number(e.target.value))}
                    className="w-full bg-black/40 border border-white/10 rounded px-2.5 py-1.5 text-xs font-mono text-white focus:outline-none"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5 font-mono text-xs border-t border-white/5 pt-2">
                <div className="flex justify-between">
                  ...
                  <span className="text-purple-400 font-bold">
                    {dopplerResult.redshift.toFixed(5)}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-white/40">Radial Velocity [v_rad]</span>
                  <span className="text-cyan-400 font-bold">
                    {dopplerResult.radialVelocityKmS.toFixed(2)} km/s
                  </span>
                </div>
              </div>
            </div>
        ...
        <ExperimentHistoryLogger
          ...
          currentOutputs={{
            z: dopplerResult.redshift,
            v_rad_km_s: dopplerResult.radialVelocityKmS,
          }}
        />

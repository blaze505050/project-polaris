...
const EXOPLANET_PRESETS = [
  ...
  {
    name: "Kepler-186f (Habitable Zone)",
    rp: 1.17,
    mp: 1.4,
    a: 0.432,
    period: 129.9,
  ...
  {
    name: "HD 209458 b (Osiris Hot Jupiter)",
    rp: 15.1,
    mp: 219.0,
    a: 0.047,
    period: 3.52,
  ...
  {
    name: "Super-Earth (High Eccentricity)",
    rp: 2.4,
    mp: 6.5,
    a: 0.12,
    period: 14.2,
...
const EXOPLANET_METADATA: SimulationMetadata = {
  ...
  unitsTable: [
    {
      symbol: "ΔF",
      name: "Transit Dip Depth",
      unit: "ppm",
      description: "Flux drop in parts per million (1% = 10,000 ppm)",
    },
    {
      symbol: "K",
      name: "RV Wobble Semi-Amplitude",
      unit: "m/s",
      description: "Stellar Doppler velocity variation amplitude",
    },
    {
      symbol: "R_p",
      name: "Planet Radius",
      unit: "R_Earth",
      description: "Planet radius relative to Earth (6,371 km)",
    },
    {
      symbol: "M_p",
      name: "Planet Mass",
      unit: "M_Earth",
      description: "Planet mass relative to Earth (5.972e24 kg)",
    },
  ],
  references: [
...
export default function ExoplanetDiscoveryEngine() {
  ...
  const transitResult: TransitLightCurveResult = useMemo(() => {
    return computeExoplanetTransitLightCurve(
      planetRadius,
      starRadius,
      semiMajorAxis,
      inclination,
  ...
  useEffect(() => {
    ...
    const timeSpan =
      transitResult.timeDays[transitResult.timeDays.length - 1] - transitResult.timeDays[0];
    ...
    ctx.fillText(
      "― Photometric Light Curve (Mandel-Agol Model)",
      margin.left + 10,
      margin.top - 10,
    );
  }, [transitResult]);
  ...
  useEffect(() => {
    ...
    ctx.fillText(
      "― Stellar Doppler Wobble Radial Velocity (m/s)",
      margin.left + 10,
      margin.top - 10,
    );
  }, [rvResult]);
    ...
    <div className="min-h-screen bg-[#060B18] text-white">
      ...
      <div className="max-w-[120rem] mx-auto px-4 md:px-[4%] py-6 space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-white/50 font-mono">
                Mandel-Agol light curve model · Stellar Doppler wobble semi-amplitude K
              </p>
            </div>
          </div>
              ...
              <div className="space-y-2 font-mono text-xs">
                <div className="flex justify-between border-b border-white/5 py-1">
                  ...
                  <span className="text-cyan-400 font-bold">
                    {transitResult.transitDepthPpm.toFixed(0)} ppm
                  </span>
                </div>
                <div className="flex justify-between border-b border-white/5 py-1">
                ...
                <div className="flex justify-between border-b border-white/5 py-1">
                  ...
                  <span className="text-pink-400 font-bold">
                    {rvResult.semiAmplitudeMS.toFixed(2)} m/s
                  </span>
                </div>
              </div>
            </div>
        ...
        <ExperimentHistoryLogger
          ...
          currentOutputs={{
            transitDepthPpm: transitResult.transitDepthPpm,
            durationHours: transitResult.durationHours,
            semiAmplitudeK_m_s: rvResult.semiAmplitudeMS,
          }}
        />

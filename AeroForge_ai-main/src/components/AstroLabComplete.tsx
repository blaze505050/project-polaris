...
export default function AstroLabComplete() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0E14] text-foreground overflow-hidden">
      ...
      <nav className="sticky top-0 z-50 bg-[#0B0E14]/95 backdrop-blur-md border-b border-[#00F0FF33] px-6 py-4">
        <div className="max-w-[120rem] mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="text-2xl font-bold font-mono text-[#00F0FF]">AstroLab // AeroForge</div>
      ...
      {/* Main Content */}
      <main className="w-full">{renderModule()}</main>
    </div>
  );
}
    ...
    <div className="w-full h-screen bg-[#0B0E14] flex flex-col">
      ...
      <div className="bg-[#131924]/60 backdrop-blur-md border-t border-[#00F0FF33] p-6">
        <div className="max-w-[120rem] mx-auto">
          <h2 className="text-xl font-bold text-[#00F0FF] font-mono mb-4">
            Spatial Intelligence & 3D Globe Engine
          </h2>
          {mode === "student" ? (
            <p className="text-secondary-foreground">
              Click on satellites to view real-time telemetry data.
            </p>
          ) : (
            <div className="grid grid-cols-4 gap-4 text-xs font-mono">
              <div>
                <span className="text-[#FF007A]">LAT:</span>{" "}
                <span className="text-[#00F0FF]">0.00°</span>
              </div>
              <div>
                <span className="text-[#FF007A]">LON:</span>{" "}
                <span className="text-[#00F0FF]">0.00°</span>
              </div>
              <div>
                <span className="text-[#FF007A]">ALT:</span>{" "}
                <span className="text-[#00F0FF]">408 km</span>
              </div>
              <div>
                <span className="text-[#FF007A]">VEL:</span>{" "}
                <span className="text-[#00F0FF]">7.66 km/s</span>
              </div>
            </div>
          )}
        </div>
...
const PhotometryModule: React.FC<{ mode: string }> = ({ mode }) => {
  ...
  return (
    <div className="w-full min-h-screen bg-[#0B0E14] p-6">
      <div className="max-w-[120rem] mx-auto">
        <h2 className="text-2xl font-bold text-[#00F0FF] font-mono mb-6">
          Photometry Suite & Light Analysis
        </h2>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Light Curve */}
          <div className="bg-[#131924]/60 backdrop-blur-md border border-[#00F0FF33] rounded-lg p-6">
            <h3 className="text-lg font-bold text-[#00F0FF] font-mono mb-4">
            ...
            <div className="aspect-video bg-gradient-to-br from-[#0B0E14] to-[#1a1f2e] rounded-lg border border-[#00F0FF33] flex items-center justify-center">
              <div className="text-center">
                ...
                <svg className="w-full h-full" viewBox="0 0 400 300">
                  ...
                  <polyline
                    points="60,200 100,150 140,120 180,100 220,110 260,140 300,180 340,220"
                    stroke="#FF007A"
                    strokeWidth="2"
                    fill="none"
                  />
            ...
            {selected && (
              <div className="mt-6 p-4 bg-[#00F0FF]/10 border border-[#00F0FF33] rounded-lg">
                <div className="text-xs font-mono space-y-2">
                  <div>
                    <span className="text-[#FF007A]">Temperature:</span>{" "}
                    <span className="text-[#00F0FF]">{selected.temp} K</span>
                  </div>
                  <div>
                    <span className="text-[#FF007A]">Color:</span>{" "}
                    <span className="text-[#00F0FF]">{selected.color}</span>
                  </div>
                </div>
              </div>
            )}
...
const AstrodynamicsModule: React.FC<{ mode: string }> = ({ mode }) => {
  ...
  return (
    <div className="w-full min-h-screen bg-[#0B0E14] p-6">
      <div className="max-w-[120rem] mx-auto">
        <h2 className="text-2xl font-bold text-[#00F0FF] font-mono mb-6">
          Astrodynamics Sandbox & Orbital Mechanics
        </h2>
          ...
          <div className="lg:col-span-2 bg-[#131924]/60 backdrop-blur-md border border-[#00F0FF33] rounded-lg p-6">
            <div className="aspect-square bg-gradient-to-br from-[#0B0E14] to-[#1a1f2e] rounded-lg border border-[#00F0FF33] flex items-center justify-center relative">
              <svg className="w-full h-full" viewBox="0 0 400 400">
                ...
                {/* Orbit path */}
                {orbitType === "circular" && (
                  <circle cx="200" cy="200" r="120" fill="none" stroke="#00F0FF" strokeWidth="2" />
                )}
          ...
          <div className="bg-[#131924]/60 backdrop-blur-md border border-[#00F0FF33] rounded-lg p-6">
            ...
            {selected && (
              <div className="mt-6 p-4 bg-[#00F0FF]/10 border border-[#00F0FF33] rounded-lg">
                <div className="text-xs font-mono space-y-2">
                  <div>
                    <span className="text-[#FF007A]">Eccentricity:</span>{" "}
                    <span className="text-[#00F0FF]">{selected.eccentricity}</span>
                  </div>
                  <div>
                    <span className="text-[#FF007A]">Apogee:</span>{" "}
                    <span className="text-[#00F0FF]">35,786 km</span>
                  </div>
                  <div>
                    <span className="text-[#FF007A]">Perigee:</span>{" "}
                    <span className="text-[#00F0FF]">200 km</span>
                  </div>
                </div>
              </div>
            )}
...
const DualModeModule: React.FC<{
  mode: string;
  setMode: (m: "student" | "professional") => void;
}> = ({ mode, setMode }) => {
  return (
    <div className="w-full min-h-screen bg-[#0B0E14] p-6">
      <div className="max-w-[120rem] mx-auto">
        <h2 className="text-2xl font-bold text-[#00F0FF] font-mono mb-6">
          Dual-Mode Experience Switcher
        </h2>
          ...
          <div className="bg-[#131924]/60 backdrop-blur-md border border-[#00F0FF33] rounded-lg p-6">
            ...
            {selected && (
              <div className="mt-6 p-4 bg-[#00F0FF]/10 border border-[#00F0FF33] rounded-lg">
                <div className="text-xs font-mono space-y-2">
                  <div>
                    <span className="text-[#FF007A]">Stars:</span>{" "}
                    <span className="text-[#00F0FF]">{selected.stars}</span>
                  </div>
                  <div>
                    <span className="text-[#FF007A]">Magnitude:</span>{" "}
                    <span className="text-[#00F0FF]">{selected.magnitude}</span>
                  </div>
                </div>
              </div>
            )}
...
const CelestialModule: React.FC<{ mode: string }> = ({ mode }) => {
  ...
  return (
    <div className="w-full min-h-screen bg-[#0B0E14] p-6">
      <div className="max-w-[120rem] mx-auto">
        <h2 className="text-2xl font-bold text-[#00F0FF] font-mono mb-6">
          Celestial Coordinate Ephemeris
        </h2>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-[#131924]/40 border border-[#00F0FF33] rounded-lg">
                  <div className="text-secondary-foreground text-xs font-mono space-y-2">
                    <div>
                      Status: <span className="text-[#10B981]">CALCULATED</span>
                    </div>
                    <div>
                      Precision: <span className="text-[#00F0FF]">±0.001%</span>
                    </div>
                  </div>
                </div>
              </div>

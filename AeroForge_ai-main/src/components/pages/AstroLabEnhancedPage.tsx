  ...
  const modules = [
    {
      ...
      icon: Sparkles,
      description:
        "Physics-accurate N-body simulation with General Relativity effects & volumetric rendering",
              ...
              <div className="flex items-start justify-between mb-6">
                <div>
                  ...
                  <p className="text-base text-secondary-foreground font-mono">
                    ISO 9001:2015 Certified | Physics-Accurate Astronomical Research Platform
                  </p>
                </div>
              </div>

...
const labTools: LabTool[] = [
  // ===== STRUCTURAL ANALYSIS =====
  {
    ...
    description:
      "Advanced finite element analysis for aerospace structures with real-time visualization",
  ...
  // Aerospace & Flight Systems
  {
    ...
    description:
      "Integrated platform for aircraft and unmanned aerial vehicle design with aerodynamic optimization",
    icon: <Rocket className="w-8 h-8" />,
...

  {
    ...
    description:
      "High-fidelity flight dynamics simulator with real-time physics and control systems",
...

  {
    ...
    description:
      "Real-time 3D environment for mission planning, terrain analysis, and flight path optimization",
  ...
  // Industrial Mechanical Engineering
  {
    ...
    description:
      "Real-time digital twins for rotating machinery, pumps, valves, compressors, and HVAC systems",
    icon: <Database className="w-8 h-8" />,
    category: "Specialized Laboratories",
...

  {
    ...
    description:
      "Comprehensive platform for programmable logic controller and distributed control system testing",
    icon: <Cpu className="w-8 h-8" />,
    category: "Specialized Laboratories",
    subcategory: "Industrial Mechanical Engineering",
...

  {
    ...
    description:
      "Advanced simulation for heating, ventilation, and air conditioning system design and optimization",
  ...
  // Advanced Dynamics & Robotics
  {
    ...
    description:
      "Real-time simulation of complex mechanical systems with rigid body dynamics and constraints",
    icon: <Layers className="w-8 h-8" />,
    category: "Specialized Laboratories",
...

  {
    ...
    description:
      "Advanced simulation for hydraulic systems, powertrains, and fluid power applications",
    icon: <Zap className="w-8 h-8" />,
    category: "Specialized Laboratories",
    subcategory: "Advanced Dynamics & Robotics",
...

  {
    ...
    description:
      "Comprehensive platform for robot design, kinematics, dynamics, and control system development",
    icon: <Wrench className="w-8 h-8" />,
    category: "Specialized Laboratories",
    subcategory: "Advanced Dynamics & Robotics",
  ...
  // Manufacturing & Digital Thread
  {
    ...
    description:
      "Unified platform for managing digital thread across product lifecycle from design to manufacturing",
    icon: <GitBranch className="w-8 h-8" />,
    category: "Specialized Laboratories",
...

  {
    ...
    description:
      "Advanced platform for smart manufacturing, IoT integration, and Industry 4.0 implementation",
...

  {
    ...
    description:
      "Immersive virtual and augmented reality platform for design review, assembly, and training",
    icon: <Lightbulb className="w-8 h-8" />,
    category: "Specialized Laboratories",
    subcategory: "Manufacturing & Digital Thread",
  ...
  // Mechanism & Kinematics
  {
    ...
    description:
      "Advanced CAD-based platform for mechanism design, kinematics analysis, and optimization",
    icon: <Wrench className="w-8 h-8" />,
    category: "Specialized Laboratories",
...

  {
    ...
    description:
      "Comprehensive kinematics and inverse kinematics solver for complex mechanical systems",
    icon: <Calculator className="w-8 h-8" />,
    category: "Specialized Laboratories",
    subcategory: "Mechanism & Kinematics",
    features: [
...

  {
    ...
    description:
      "Ergonomic analysis and digital human modeling for product design and workplace optimization",
    icon: <Users className="w-8 h-8" />,
    category: "Specialized Laboratories",
    subcategory: "Mechanism & Kinematics",
  ...
  // ===== ASTROLAB - SPATIAL INTELLIGENCE & 3D GLOBE ENGINE =====
  {
    ...
    description:
      "Real-time 3D geospatial visualization with satellite propagation and orbital mechanics",
...

  {
    ...
    features: [
      "Aladin Lite Engine",
      "Pan-STARRS/DSS Surveys",
      "Coordinate Targeting",
      "Multi-Spectral Overlays",
    ],
...

  {
    ...
    description:
      "Interactive orbital mechanics with N-Body gravity simulation and mission planning",
...

  {
    ...
    description:
      "Seamless switching between Student and Professional modes for all astronomical tools",
...
export default function VirtualLabPage() {
  ...
  const categories = categoryOrder.filter((cat) => labTools.some((t) => t.category === cat));
        ...
        <section className="w-full max-w-[120rem] mx-auto px-4 py-20 md:py-32">
          ...
          >
            ...
            <p className="font-paragraph text-xl md:text-2xl text-slate-300 max-w-3xl mx-auto mb-8">
              Integrated tools for aerospace, mechanical, and astronomical research. {activeCount}{" "}
              tools ready to use.
            </p>
                ...
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="font-paragraph text-slate-300 mb-4">
                      Powered by advanced multi-physics simulation with atmospheric modeling,
                      aerodynamic analysis, structural mechanics, thermal analysis, propulsion
                      dynamics, orbital mechanics, and numerical integration.
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="bg-slate-700/50 rounded-lg p-3">
                        <p className="font-paragraph text-sm font-semibold text-blue-300 mb-1">
                          Atmospheric Model
                        </p>
                        <p className="font-paragraph text-xs text-slate-400">
                          US Standard Atmosphere 1976 up to 86km
                        </p>
                      </div>
                      <div className="bg-slate-700/50 rounded-lg p-3">
                        <p className="font-paragraph text-sm font-semibold text-cyan-300 mb-1">
                          Aerodynamics
                        </p>
                        <p className="font-paragraph text-xs text-slate-400">
                          Subsonic to hypersonic with compressibility
                        </p>
                      </div>
                      <div className="bg-slate-700/50 rounded-lg p-3">
                        <p className="font-paragraph text-sm font-semibold text-purple-300 mb-1">
                          Numerical Methods
                        </p>
                        <p className="font-paragraph text-xs text-slate-400">
                          RK4 with adaptive step control
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div className="mb-8">
                      ...
                      <p className="text-slate-400 mt-3 text-lg">
                        {category === "Advanced Modules" &&
                          "Specialized aerospace analysis and design modules"}
                        {category === "Products" && "Production-ready tools and resources"}
                        {category === "Research" && "Advanced research and development tools"}
                        {category === "Elite Suite" &&
                          "Enterprise-grade optimization and collaboration"}
                        {category === "Core Tools" &&
                          "Essential aerospace design and simulation tools"}
                        {category === "Specialized Laboratories" &&
                          "World-class virtual engineering labs for aerospace, mechanical, and manufacturing"}
                        {category === "AstroLab" &&
                          "Advanced astronomical and space research tools with satellite tracking and deep-space observation"}
                      </p>
                    </div>
                        ...
                        >
                          <div className="relative h-full bg-slate-800 rounded-xl overflow-hidden border border-slate-700 hover:border-slate-600 transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/20">
                            ...
                            <div className="relative p-8 h-full flex flex-col">
                              {/* Icon */}
                              <div
                                className={`w-16 h-16 rounded-lg bg-gradient-to-br ${tool.color} p-3 mb-6 flex items-center justify-center text-white`}
                              >
                                {tool.icon}
                              </div>
                              ...
                              <div className="mb-6">
                                ...
                                <ul className="space-y-2">
                                  {tool.features.map((feature, i) => (
                                    <li
                                      key={i}
                                      className="font-paragraph text-sm text-slate-400 flex items-start"
                                    >
              ...
              {[
                {
                  ...
                  description:
                    "All tools work seamlessly together for complete aerospace, mechanical, and astronomical workflows",
                },
                {
                  icon: Gauge,
                  title: "Research-Grade Physics",
                  description:
                    "Validated analytical and reduced-order algorithms with published reference data",
                },
                {
                  icon: Brain,
                  title: "AI-Powered",
                  description:
                    "Intelligent suggestions and automated optimization across all tools",
                },
                {
                  icon: BarChart3,
                  title: "Real-Time Analytics",
                  description:
                    "Live monitoring, convergence tracking, and performance visualization",
                },
              ].map((feature, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="font-paragraph text-slate-100">{feature.description}</p>
                  </div>
                );
              })}
            </div>
        ...
        <section className="w-full max-w-[120rem] mx-auto px-4 py-20">
          ...
          >
            ...
            <p className="font-paragraph text-xl text-slate-300 mb-12 max-w-2xl mx-auto">
              Choose a tool above and start your research journey. All tools are fully functional
              and ready to use.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                >
                  ...
                  <p className="font-paragraph text-slate-400">{item.desc}</p>
                </motion.div>
              ))}
            </div>
          </motion.div>
        ...
        <section className="w-full max-w-[120rem] mx-auto px-4 py-20">
          ...
          >
            ...
            <p className="font-paragraph text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
              Access all aerospace, mechanical, and astronomical research tools in one unified
              environment. Start designing, simulating, and optimizing today.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}

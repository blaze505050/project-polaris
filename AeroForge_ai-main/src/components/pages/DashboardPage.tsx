        ...
        <main className="flex-1 lg:ml-64 p-4 md:p-6 space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-white/50">Engineering workspace overview</p>
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <div className="bg-[#080E1C] border border-white/10 rounded-lg p-3.5 flex items-center justify-between">
              <div>
                <span className="text-[10px] text-white/50 uppercase">PROJECTS</span>
                <div className="text-2xl font-bold text-cyan-400 mt-0.5">{projects.length}</div>
              </div>
            ...
            <div className="bg-[#080E1C] border border-white/10 rounded-lg p-3.5 flex items-center justify-between">
              <div>
                <span className="text-[10px] text-white/50 uppercase">ACTIVE</span>
                <div className="text-2xl font-bold text-emerald-400 mt-0.5">{activeProjects}</div>
              </div>
            ...
            <div className="bg-[#080E1C] border border-white/10 rounded-lg p-3.5 flex items-center justify-between">
              <div>
                <span className="text-[10px] text-white/50 uppercase">COMPLETED</span>
                <div className="text-2xl font-bold text-amber-400 mt-0.5">{completedProjects}</div>
              </div>
            ...
            <div className="bg-[#080E1C] border border-white/10 rounded-lg p-3.5 flex items-center justify-between">
              <div>
                <span className="text-[10px] text-white/50 uppercase">LABS AVAILABLE</span>
                <div className="text-2xl font-bold text-purple-400 mt-0.5">3</div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              {projects.length === 0 && (
                <div className="mt-6 p-8 bg-[#080E1C] border border-white/10 rounded-lg text-center">
                  ...
                  <p className="text-sm text-white/60 mb-1">No projects yet</p>
                  <p className="text-xs text-white/40 mb-4">
                    Create your first engineering project or explore the demo projects
                  </p>
                  <Link
                    to="/projects"
            ...
            <div className="bg-[#080E1C] border border-white/10 rounded-lg p-4 space-y-4">
              ...
              <p className="text-[10px] text-white/40">Current capability status</p>
              ...
              <div className="space-y-2 text-xs">
                {platformFeatures.map((feature) => (
                  ...
                  >
                    <span className="text-white/80 text-[11px]">{feature.name}</span>
                    <span

...
export default function DocumentationPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    "architecture" | "solvers" | "api" | "research" | "roadmaps" | "dsl" | "results" | "manual"
  >("architecture");
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div>
                ...
                <h1 className="font-heading text-3xl font-extrabold text-white">
                  Engineering & API Technical Reference
                </h1>
              </div>
              ...
              <div className="max-w-5xl space-y-10">
                <div>
                  ...
                  <h1 className="font-heading text-4xl font-bold text-white">
                    AeroForge AI Engineering Manual
                  </h1>
                  <p className="font-sans text-sm text-white/60 mt-1">
                    Exhaustive reference manual detailing physics governing equations, solver
                    taxonomies, REST API endpoints, and Physics AI neural operator models.
                  </p>
                </div>
                  ...
                  <div className="space-y-4 text-xs font-sans text-white/70">
                    <div className="bg-[#050914] p-4 rounded-lg border border-white/5 space-y-2 font-mono">
                      <span className="text-cyan-300 font-bold block text-sm">
                        1.1 Thin Airfoil Theory Solver
                      </span>
                      <p className="text-white/60 text-xs font-sans">
                        Calculates linear lift coefficient, pitching moment, and zero-lift angle of
                        attack for thin 2D section profiles under subcritical flow.
                      </p>
                      ...
                      <p className="text-[11px] text-white/40 font-sans">
                        Assumptions: Incompressible, inviscid flow, t/c &lt; 0.12, small alpha &lt;
                        12 deg.
                      </p>
                    </div>
                    ...
                    <div className="bg-[#050914] p-4 rounded-lg border border-white/5 space-y-2 font-mono">
                      <span className="text-cyan-300 font-bold block text-sm">
                        1.2 Prandtl-Glauert Compressibility Correction
                      </span>
                      <p className="text-white/60 text-xs font-sans">
                        Applies linearized subsonic Mach number scaling to static pressure
                        coefficients.
                      </p>
                      <div className="bg-[#02050C] p-3 rounded border border-white/10 text-emerald-400 text-xs font-mono">
                  ...
                  <div className="space-y-4 text-xs font-sans text-white/70">
                    <div className="bg-[#050914] p-4 rounded-lg border border-white/5 space-y-2 font-mono">
                      <span className="text-amber-300 font-bold block text-sm">
                        2.1 Euler-Bernoulli Beam Bending Solver
                      </span>
                      <p className="text-white/60 text-xs font-sans">
                        Calculates maximum deflection and von Mises bending stress for cantilevered
                        and simply supported engineering beams.
                      </p>
                  ...
                  <div className="space-y-4 text-xs font-sans text-white/70">
                    <div className="bg-[#050914] p-4 rounded-lg border border-white/5 space-y-2 font-mono">
                      <span className="text-purple-300 font-bold block text-sm">
                        3.1 Vis-Viva Orbital Velocity & Escape Solver
                      </span>
                      <p className="text-white/60 text-xs font-sans">
                        Solves 2-body Keplerian orbital velocities, period, and parabolic escape
                        velocity.
                      </p>
            ...
            >
              <div className="max-w-5xl space-y-12">
                <div>
                  ...
                  <h1 className="font-heading text-4xl text-white mt-2 font-bold">
                    System Migration & Solver Adapters
                  </h1>
                  <p className="font-sans text-sm text-white/60 mt-1">
                    Architectural specifications for Data Persistence migration (Zustand →
                    PostgreSQL) and Real External Physics Solvers (XFOIL, OpenFOAM, SU2).
                  </p>
                </div>
                ...
                <div className="bg-[#0A1020] border border-white/10 rounded-xl p-6 md:p-8 space-y-6 shadow-xl">
                  <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                    ...
                    <div>
                      <h2 className="text-lg font-bold text-white">
                        1. Data Persistence Migration Roadmap
                      </h2>
                      <p className="text-xs text-white/50 font-sans">
                        Transition path from Local-First Zustand + localStorage to Cloud
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
                    <div className="bg-[#060B18] p-4 rounded-lg border border-cyan-500/30 space-y-2">
                      ...
                      <p className="text-white/60 font-sans leading-relaxed">
                        Local browser storage. Fast zero-latency offline performance. Limited to 5MB
                        quota per origin. Single user sandbox.
                      </p>
                    </div>
                    ...
                    <div className="bg-[#060B18] p-4 rounded-lg border border-amber-500/30 space-y-2">
                      ...
                      <p className="text-white/60 font-sans leading-relaxed">
                        User authentication via OAuth 2.0. Relational schema for Projects,
                        Experiments, Notebooks, and Digital Thread provenance logs.
                      </p>
                    </div>

                    <div className="bg-[#060B18] p-4 rounded-lg border border-emerald-500/30 space-y-2">
                      <span className="text-[10px] text-emerald-400 font-bold uppercase">
                        PHASE 3: OBJECT & REALTIME
                      </span>
                      <h3 className="font-bold text-white text-sm">S3 / Cloud Storage + WS</h3>
                      <p className="text-white/60 font-sans leading-relaxed">
                        Blob storage for binary STL/CAD geometries, large CFD mesh files, and result
                        plots. Realtime WebSocket sync for team collaboration.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#060B18] p-4 rounded-lg border border-white/5 space-y-2 font-mono text-xs">
                    <span className="text-[10px] text-white/40 uppercase font-bold">
                      EXACT DATABASE SCHEMA SPECIFICATION
                    </span>
...
CREATE TABLE digital_thread (id UUID PRIMARY KEY, experiment_id UUID REFERENCES experiments(id), hash TEXT, provenance_data JSONB);`}
                ...
                <div className="bg-[#0A1020] border border-white/10 rounded-xl p-6 md:p-8 space-y-6 shadow-xl">
                  <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                    ...
                    <div>
                      <h2 className="text-lg font-bold text-white">
                        2. Real SolverAdapter Architecture Roadmap
                      </h2>
                      <p className="text-xs text-white/50 font-sans">
                        Integration roadmap for external viscous, high-fidelity CFD, and FEA
                        solvers.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div
                        key={solver.id}
                        className="p-4 bg-[#060B18] rounded-xl border border-white/5 space-y-2"
                      >
              ...
              <div className="max-w-5xl">
                <div className="mb-16">
                  ...
                  <p className="font-paragraph text-lg text-foreground/70 max-w-3xl">
                    Complete reference for the AeroForge design language. Deterministic, versioned,
                    and fully validated.
                  </p>
                </div>
                ...
                <div className="mb-16">
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div
                        key={idx}
                        className="p-4 bg-primary border border-secondary/20 rounded-lg flex items-start gap-3"
                      >
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-paragraph text-base text-foreground/80">
                        The following API contract is defined for backend implementation. Execution
                        backend runs locally or in private infrastructure. No public endpoints are
                        currently available.
                      </p>
                    </div>
                  </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          {errors.map((error, idx) => (
                            <div
                              key={idx}
                              className="p-4 bg-aerospace-danger/10 border border-aerospace-danger/30 rounded-lg flex items-start gap-3"
                            >
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          {warnings.map((warning, idx) => (
                            <div
                              key={idx}
                              className="p-4 bg-aerospace-warning/10 border border-aerospace-warning/30 rounded-lg flex items-start gap-3"
                            >
              ...
              <div className="max-w-5xl space-y-6">
                <div>
                  <h1 className="font-heading text-3xl text-foreground mb-2">
                    Zero-Cost Research Discovery Layer
                  </h1>
                  <p className="font-paragraph text-sm text-foreground/70">
                    Search peer-reviewed literature across public <strong>arXiv</strong> and{" "}
                    <strong>OpenAlex</strong> REST APIs with instant BibTeX, IEEE, and APA citation
                    generation.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {(papers.length > 0
                    ...
                    : [
                        {
                          ...
                          abstract:
                            "Comprehensive experimental and theoretical summary of NACA airfoils.",
                        ...
                        },
                        {
                          ...
                          abstract:
                            "Derivation of the ideal rocket equation relating delta-v to mass ratio.",
                          source: "AeroForge Benchmark Archive" as const,
                          citationsCount: 8900,
                        },
                      ]
                    ...
                    <div
                      key={paper.id}
                      className="p-4 bg-[#080E1C] border border-white/10 rounded-xl space-y-3 font-mono"
                    >
                      ...
                      <p className="text-[11px] text-white/40 font-sans line-clamp-2">
                        {paper.abstract}
                      </p>

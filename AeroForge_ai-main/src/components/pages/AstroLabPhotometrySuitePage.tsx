...
export default function AstroLabPhotometrySuitePage() {
  ...
  const calculatePhotometry = () => {
    ...
    const skyPhotons =
      collectingPower * exposureTime * Math.pow(10, -skyBrightness / 2.5) * apertureArea;
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-secondary-foreground font-mono text-sm mt-2">
                Professional Stellar Photometry & Aperture Analysis
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-[#131924]/60 backdrop-blur-md border border-[#00F0FF]/20 rounded p-6">
              ...
              <div className="space-y-3">
                <div>
                  <label className="text-xs font-mono text-secondary-foreground">
                    Aperture Diameter (m)
                  </label>
                  <input
                    type="range"
            ...
            <div className="bg-[#131924]/60 backdrop-blur-md border border-[#00F0FF]/20 rounded p-6">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  />
                  <div className="text-sm font-mono text-[#00F0FF] mt-1">
                    {DataFormatter.magnitude(targetMagnitude)}
                  </div>
                </div>
                <div>
                  <label className="text-xs font-mono text-secondary-foreground">
                  ...
                  />
                  <div className="text-sm font-mono text-[#00F0FF] mt-1">
                    {skyBrightness.toFixed(1)} mag/arcsec²
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-xs font-mono">
                  ...
                  <span className="text-[#00F0FF]">
                    {(photometry.apertureArea * 1e4).toFixed(2)} cm²
                  </span>
                </div>
                <div className="flex justify-between text-xs font-mono">
                  <span className="text-secondary-foreground">Signal Photons:</span>
                  <span className="text-[#00F0FF]">
                    {photometry.signalPhotons.toLocaleString()}
                  </span>
                </div>
                <div className="flex justify-between text-xs font-mono">
                ...
                <div className="flex justify-between text-xs font-mono">
                  ...
                  <span className="text-[#F59E0B]">
                    {DataFormatter.magnitude(parseFloat(photometry.limitingMagnitude))}
                  </span>
                </div>
              </div>
            </div>

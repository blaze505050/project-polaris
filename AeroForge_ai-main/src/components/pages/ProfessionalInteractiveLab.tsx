...
const ProfessionalInteractiveLab: React.FC = () => {
  ...
  const [selectedCategory, setSelectedCategory] = useState<
    "all" | "physics" | "telemetry" | "analysis" | "control"
  >("all");
        ...
        <section className="w-full max-w-[120rem] mx-auto px-4 md:px-[8%] py-12 md:py-20">
          ...
          >
            ...
            <p className="text-lg text-secondary-foreground max-w-2xl">
              Industrial-grade simulation environment with real-time physics manipulation, advanced
              telemetry streaming, and mission-control style analytics.
            </p>
          </motion.div>
                ...
                >
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div
                        className={`${activeModule === module.id ? "text-aerospace-blue" : "text-secondary-foreground"}`}
                      >
                        {module.icon}
                      </div>
                      {activeModule === module.id && (
                      ...
                      <Card className="bg-primary/50 border-aerospace-blue/20 p-6">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                          {[
                            ...
                            <div
                              key={idx}
                              className="bg-aerospace-dark/50 p-4 rounded border border-aerospace-blue/20"
                            >
                              <div className="text-xs text-secondary-foreground mb-1">
                                {metric.label}
                              </div>
                              <div className="text-2xl font-mono font-bold text-aerospace-blue">
                                {metric.value}
                              </div>
                              <div className="text-xs text-aerospace-success mt-1">
                                {metric.trend}
                              </div>
                            </div>
                          ))}

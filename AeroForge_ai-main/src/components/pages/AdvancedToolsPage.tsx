...
const ADVANCED_TOOLS: AdvancedTool[] = [
  {
    ...
    description:
      "High-fidelity computational fluid dynamics with turbulence modeling, multiphase flow, and real-time visualization for aerospace applications.",
    difficulty: "Expert",
    features: [
  ...
  },
  {
    ...
    description:
      "Enterprise-grade finite element analysis with nonlinear dynamics, composite materials, and fatigue analysis for aerospace structures.",
    difficulty: "Expert",
    features: [
      "Nonlinear Dynamics",
  ...
  },
  {
    ...
    description:
      "Integrated turbomachinery design tool with thermodynamic cycle analysis, blade design, and performance prediction.",
    difficulty: "Expert",
    features: [
  ...
  },
  {
    ...
    description:
      "Real-time flight dynamics simulation with control law development, stability analysis, and hardware-in-the-loop testing.",
    difficulty: "Expert",
    features: [
  ...
  },
  {
    ...
    description:
      "Machine learning-powered materials selection and property prediction for aerospace applications with database of 50,000+ materials.",
    difficulty: "Advanced",
    features: [
  ...
  },
  {
    ...
    description:
      "Advanced trajectory optimization with fuel efficiency, obstacle avoidance, and multi-objective optimization for flight paths.",
    difficulty: "Expert",
    features: [
  ...
  },
  {
    ...
    description:
      "Comprehensive thermal analysis including radiation, convection, conduction, and transient heat transfer for hypersonic vehicles.",
    difficulty: "Expert",
    features: [
  ...
  },
  {
    ...
    description:
      "Modal analysis, harmonic response, random vibration, and shock response spectrum analysis for aerospace structures.",
    difficulty: "Advanced",
    features: [
      "Modal Analysis",
      "Harmonic Response",
  ...
  },
  {
    ...
    description:
      "Integrated radar design, antenna optimization, and sensor fusion for aerospace navigation and detection systems.",
    difficulty: "Expert",
    features: [
  ...
  },
  {
    ...
    description:
      "Advanced composite layup design with failure criteria, micromechanics, and manufacturing process simulation.",
    difficulty: "Expert",
    features: [
  ...
  },
  {
    ...
    category: "Acoustics",
    description:
      "Comprehensive noise prediction including jet noise, airframe noise, and community noise impact assessment.",
    difficulty: "Expert",
    features: [
      "Jet Noise Modeling",
      "Airframe Noise",
  ...
  },
  {
    ...
    description:
      "Integrated multidisciplinary design optimization combining aerodynamics, structures, propulsion, and controls.",
    difficulty: "Expert",
    features: [
      "MDO Framework",
  ...
  },
  {
    ...
    description:
      "Real-time digital twin creation with sensor integration, predictive maintenance, and performance monitoring.",
    difficulty: "Advanced",
    features: [
            ...
            <div className="sticky top-0 flex items-center justify-between p-6 border-b border-aerospace-blue/20 bg-primary/95 backdrop-blur">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-mono text-xs text-aerospace-blue uppercase tracking-widest">
                    {dataset.category}
                  </p>
                </div>
              </div>
...
export default function AdvancedToolsPage() {
  ...
  const categories = useMemo(() => [...new Set(ADVANCED_TOOLS.map((t) => t.category))], []);
          ...
          <div className="w-full max-w-[120rem] mx-auto px-6 md:px-12 lg:px-16 relative z-10">
            ...
            >
              ...
              <p className="font-paragraph text-xl text-secondary-foreground max-w-4xl mx-auto mb-8 leading-relaxed">
                Enterprise-grade simulation, optimization, and analysis tools designed for aerospace
                engineers who demand precision, performance, and innovation. Master the most
                advanced computational tools in the industry.
              </p>
            ...
            <div className="w-full max-w-[120rem] mx-auto px-6 md:px-12 lg:px-16">
              ...
              >
                ...
                <p className="font-paragraph text-lg text-secondary-foreground max-w-3xl">
                  Download and explore real-world CFD datasets, simulation models, and benchmark
                  cases for your research and development.
                </p>
              </motion.div>
              ...
              {[
                {
                  ...
                  description:
                    "Validated against real-world aerospace data with 99%+ accuracy rates",
                  icon: CheckCircle2,
                  color: "from-green-500 to-emerald-500",
                },
                {
                ...
                return (
                  ...
                  >
                    <div
                      className={`p-3 bg-gradient-to-br ${capability.color} rounded-lg w-fit mb-4`}
                    >
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="font-paragraph text-lg text-secondary-foreground max-w-3xl mx-auto mb-8">
                  Join thousands of aerospace engineers using our tools to design the future of

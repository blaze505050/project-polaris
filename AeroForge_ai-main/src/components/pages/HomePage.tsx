...
const PROBLEM_ENTRIES = [
  { title: 'Analyze an Airfoil', desc: 'Thin airfoil theory, NACA 4-digit profiles & C_L/C_D polars', icon: Wind, path: '/aerolab', tag: 'AERODYNAMICS' },
  { title: 'Optimize a Wing', desc: 'Multi-objective Pareto optimization & morphing UAV study', icon: Target, path: '/flagship-workflow', tag: 'OPTIMIZATION' },
...
export default function HomePage() {
  ...
  const [activeDomain, setActiveDomain] = useState<'aerospace' | 'mechanical' | 'astrospace'>('aerospace');
          ...
          <div className="max-w-[84rem] mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              >
                ...
                <span className="text-[10px] text-slate-400 font-mono">AEROSPACE • MECHANICAL • ASTROSPACE</span>
              </motion.div>
              ...
              >
                A browser-based engineering research workstation. Connect requirements, 3D wing geometries, reduced-order physics solvers, notebooks, and scientific benchmarks into one persistent digital thread.
              </motion.p>
          ...
          <div className="max-w-[84rem] mx-auto space-y-12">
            <div className="flex flex-col md:flex-row items-start justify-between gap-6">
              ...
              <p className="text-slate-400 text-sm font-sans max-w-xl leading-relaxed">
                As you iterate, AeroForge continuously transforms geometry into mesh, runs reduced-order solvers, outputs pressure fields, and links validation error back to mission requirements.
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
              {[
                { step: '01', title: 'REQUIREMENTS', desc: 'Define target L/D > 14.5 and SF > 1.5 bounds', icon: FileText, color: 'text-cyan-400' },
                { step: '02', title: 'GEOMETRY', desc: 'Parametric NACA 4-digit airfoil curve generation', icon: Layers, color: 'text-blue-400' },
                { step: '03', title: 'SOLVER RUN', desc: '2D thin airfoil potential flow + Prandtl-Glauert', icon: Cpu, color: 'text-emerald-400' },
                { step: '04', title: 'RESULTS', desc: 'C_L vs Alpha polars & pressure gradient maps', icon: BarChart3, color: 'text-amber-400' },
                { step: '05', title: 'VALIDATION', desc: 'Abbott (1959) wind tunnel dataset cross-check', icon: CheckCircle2, color: 'text-purple-400' },
              ].map((item, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="text-xs font-bold text-white font-mono group-hover:text-cyan-300 transition-colors">{item.title}</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {DOMAINS.map((domain) => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className={`p-3 rounded-xl bg-white/5 border border-white/10 ${domain.color}`}>
                    ...
                    <p className="text-xs text-slate-300 font-sans leading-relaxed">{domain.desc}</p>
        ...
        <section className="relative w-full py-24 border-b border-white/10 px-6 md:px-12 bg-slate-950/90">
          <div className="max-w-[84rem] mx-auto space-y-8">
            <div className="flex flex-col md:flex-row items-start justify-between gap-6">
              ...
              <p className="text-slate-400 text-sm font-sans max-w-xl leading-relaxed">
                Nothing in AeroForge exists in isolation. Click any node in the provenance graph to navigate directly into its live project state.
              </p>
            </div>
          ...
          <div className="max-w-[84rem] mx-auto space-y-10">
            ...
            <div className="p-6 bg-slate-900/90 border border-white/10 rounded-2xl grid grid-cols-1 lg:grid-cols-3 gap-6 font-mono text-xs">
              <div className="space-y-3">
                <span className="text-cyan-400 font-bold text-[10px] uppercase">01 // PARAMETRIC WING MESH</span>
                <p className="text-slate-300 font-sans leading-relaxed">
                  Morphing wing trailing edge deflection angle \(\delta \in [-5^\circ, +15^\circ]\) with adaptive camber variation.
                </p>
              ...
              <div className="space-y-3">
                <span className="text-cyan-400 font-bold text-[10px] uppercase">02 // MULTI-OBJECTIVE PARETO</span>
                <p className="text-slate-300 font-sans leading-relaxed">
                  Simultaneous maximization of cruise L/D ratio while minimizing root bending stress moment M_x.
                </p>
              ...
              <div className="space-y-3">
                <span className="text-cyan-400 font-bold text-[10px] uppercase">03 // NOTEBOOK & PUBLISH</span>
                <p className="text-slate-300 font-sans leading-relaxed">
                  Export complete reproducible package with LaTeX equations, dataset CSV, and public verification link.
                </p>
          ...
          <div className="max-w-[84rem] mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 font-mono text-xs">
              <div className="p-6 bg-slate-900/90 border border-emerald-500/30 rounded-xl space-y-3">
                <span className="text-[10px] font-bold text-emerald-400 uppercase block">NACA 2412 AIRFOIL BENCHMARK</span>
              ...
              <div className="p-6 bg-slate-900/90 border border-cyan-500/30 rounded-xl space-y-3">
                <span className="text-[10px] font-bold text-cyan-400 uppercase block">EULER-BERNOULLI SPAR DEFLECTION</span>
                <div className="flex items-center justify-between text-slate-300">
              ...
              <div className="p-6 bg-slate-900/90 border border-purple-500/30 rounded-xl space-y-3">
                <span className="text-[10px] font-bold text-purple-400 uppercase block">HOHMANN ORBITAL TRANSFER ΔV</span>
                <div className="flex items-center justify-between text-slate-300">
          ...
          <div className="max-w-[84rem] mx-auto space-y-8">
            ...
            <div className="p-6 bg-slate-900/90 border border-cyan-500/30 rounded-2xl grid grid-cols-1 md:grid-cols-3 gap-6 font-mono text-xs">
              <div className="space-y-2">
                ...
                <h3 className="text-sm font-bold text-white font-sans">Fourier Neural Operator (FNO-2D)</h3>
                <p className="text-slate-400 text-[11px] font-sans">Trained on 10,000 OpenFOAM RANS CFD flow field samples for 14ms surrogate predictions.</p>
              </div>

              <div className="space-y-2">
                <span className="text-[10px] text-slate-400 uppercase">CLASSIFICATION</span>
                <h3 className="text-sm font-bold text-cyan-400 font-sans">PHYSICS AI — EXPERIMENTAL</h3>
                <p className="text-slate-400 text-[11px] font-sans">Clearly distinguished from validated analytical tools. Fast initial design space screening.</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-slate-400 text-[11px] font-sans">100x faster than traditional 3D RANS mesh solver iteration loops.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-[84rem] mx-auto space-y-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="p-8 bg-slate-900/90 border border-white/10 rounded-2xl space-y-4">
                ...
                <h3 className="text-xl font-bold text-white font-sans">arXiv & OpenAlex Integration</h3>
                <p className="text-xs text-slate-300 font-sans leading-relaxed">
                  Search live peer-reviewed aerospace papers directly inside your notebook. Generate instant IEEE and BibTeX citations tied to your project equations.
                </p>
                <Link to="/documentation?tab=research" className="inline-flex items-center gap-2 text-xs text-cyan-400 font-mono font-bold hover:underline">
              ...
              <div className="p-8 bg-slate-900/90 border border-white/10 rounded-2xl space-y-4">
                ...
                <h3 className="text-xl font-bold text-white font-sans">Shareable Engineering Knowledge</h3>
                <p className="text-xs text-slate-300 font-sans leading-relaxed">
                  Turn verified simulation runs into public scientific artifacts. Collaborators can duplicate complete experiments with 1 click.
                </p>
                <Link to="/share/ART-DEMO-01" className="inline-flex items-center gap-2 text-xs text-purple-400 font-mono font-bold hover:underline">
          ...
          <div className="max-w-[84rem] mx-auto space-y-6">
            ...
            >
              ...
              <p className="text-slate-400 text-sm max-w-xl mx-auto font-sans">
                Launch AeroForge in your browser. Complete engineering workspace with 54 physics tools and zero installation.
              </p>
              <div className="pt-4">
                <Link
                  to="/projects"

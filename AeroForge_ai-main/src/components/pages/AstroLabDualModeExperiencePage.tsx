        ...
        >
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-secondary-foreground text-sm">
                Switch between Student and Professional modes for tailored workflows
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-secondary-foreground mb-4">
                Designed for astronomy students and enthusiasts who want to learn through
                interactive exploration with guided support.
              </p>
            ...
            >
              ...
              <p className="text-secondary-foreground mb-4">
                Designed for researchers, engineers, and professionals who need full control and
                      ...
                      <div className="flex-1">
                        ...
                        <ul className="space-y-1">
                          {feature.details.map((detail, i) => (
                            <li
                              key={i}
                              className="text-xs text-secondary-foreground flex items-center gap-2"
                            >
                ...
                <table className="w-full text-sm font-mono">
                  ...
                  <tbody>
                    {comparisonData.map((row, idx) => (
                      <tr
                        key={idx}
                        className="border-b border-[#00F0FF33] hover:bg-[#0B0E14]/50 transition"
                      >
            ...
            <div className="bg-[#131924]/60 backdrop-blur-md border border-[#00F0FF33] rounded-lg p-6">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li
                    key={idx}
                    className="flex items-start gap-3 text-secondary-foreground text-sm"
                  >
          ...
          <div className="bg-gradient-to-r from-[#00F0FF]/10 to-[#FF007A]/10 border border-[#00F0FF33] rounded-lg p-8 text-center">
            ...
            <p className="text-secondary-foreground mb-6">
              Choose your mode and explore the AstroLab suite. You can switch modes anytime from

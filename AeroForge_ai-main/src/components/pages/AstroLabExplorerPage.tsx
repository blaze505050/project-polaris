  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 to-slate-950">
      ...
      <main className="max-w-7xl mx-auto px-4 py-16">
        ...
        >
          <h1 className="text-5xl font-bold text-white mb-4">ASTROLAB Explorer</h1>
          <p className="text-xl text-slate-300 max-w-2xl mx-auto">
            Dive into interactive simulations of orbital mechanics, gravity, exoplanet detection,
              ...
              >
                <Link to={mode.path}>
                  <Card className="h-full bg-slate-800 border-slate-700 hover:border-slate-500 transition-all cursor-pointer group">
                    <div className="p-6">
                      <div
                        className={`w-12 h-12 rounded-lg bg-gradient-to-br ${mode.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                      >
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/my-lab">
              <Button className="bg-blue-600 hover:bg-blue-700">My Lab (Saved Experiments)</Button>
            </Link>

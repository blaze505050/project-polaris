    ...
    <div className="min-h-screen bg-[#0B0E14] text-foreground flex flex-col">
      ...
      <main className="flex-1 w-full max-w-[120rem] mx-auto px-6 py-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
          ...
          {/* Modules Grid - Professional Layout */}
          <div>
              ...
              {modules.map((module, idx) => {
                ...
                return (
                  <motion.button
                    ...
                    className="text-left p-5 rounded border border-[#00F0FF]/20 bg-[#131924]/60 backdrop-blur-md hover:border-[#00F0FF]/50 hover:bg-[#131924]/80 transition-all group"
                  >
          ...
          {/* Capabilities Section - Professional Features */}

...
export default function AstroLabOrbitalMechanicsPage() {
  ...
  const escapeVelocity = getEscapeVelocity(
    semiMajorAxis,
    GM / AstronomicalConstants.GRAVITATIONAL_CONSTANT,
  );
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-secondary-foreground font-mono text-sm mt-2">
                Keplerian Elements & Orbital Dynamics Analysis
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-[#131924]/60 backdrop-blur-md border border-[#00F0FF]/20 rounded p-6">
              ...
              <input
                ...
                className="w-full"
              />
              <div className="text-sm font-mono text-[#00F0FF] mt-3">
                {DataFormatter.distance(semiMajorAxis)}
              </div>

        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-white/40 font-mono">
              20 Working Tools · Solid Mechanics · Thermal · Fluids · Power Systems · Materials
            </p>
          </div>
        </div>
...
function ToolRenderer({ toolId }: { toolId: ToolId }) {
  switch (toolId) {
    ...
    case "strain":
      return <StrainTool />;
    case "youngs-modulus":
      return <YoungsModulusTool />;
    case "fos":
      return <FOSTool />;
    case "beam-bending":
      return <BeamBendingTool />;
    case "shaft-torsion":
      return <ShaftTorsionTool />;
    case "power-torque":
      return <PowerTorqueTool />;
    case "thermal-conduction":
      return <ThermalConductionTool />;
    case "convection":
      return <ConvectionTool />;
    case "radiation":
      return <RadiationTool />;
    case "lmtd":
      return <LMTDTool />;
    case "reynolds-pipe":
      return <ReynoldsPipeTool />;
    case "bernoulli":
      return <BernoulliTool />;
    case "pipe-drop":
      return <PipeDropTool />;
    case "pump-power":
      return <PumpPowerTool />;
    case "pump-performance":
      return <PumpPerformanceTool />;
    case "natural-freq":
      return <NaturalFreqTool />;
    case "spring":
      return <SpringTool />;
    case "gear-ratio":
...
function StressTool() {
  return (
    <ToolShell
      ...
      description="Calculate normal or shear stress from applied force and cross-sectional area"
      domain="Solid Mechanics · Strength of Materials"
      accentColor={AMBER}
      inputs={[
...
function StrainTool() {
  return (
    <ToolShell
      ...
      description="Calculate engineering strain from deformation and original length"
      domain="Solid Mechanics · Material Testing"
      accentColor={AMBER}
      inputs={[
        {
          key: "deformation",
          label: "Deformation (ΔL)",
          unit: "m",
          defaultValue: 0.001,
          step: 0.0001,
        },
      ...
      equations={["ε = ΔL / L₀"]}
      assumptions={[
        "Engineering strain (not true strain)",
        "Small deformation assumed",
        "Uniaxial loading",
      ]}
      onCalculate={(v) => {
...
function YoungsModulusTool() {
  return (
    <ToolShell
      ...
      description="Calculate elastic modulus from stress and strain"
      domain="Solid Mechanics · Material Properties"
      accentColor={AMBER}
      inputs={[
...
function FOSTool() {
  return (
    <ToolShell
      ...
      description="Evaluate structural safety margin"
      domain="Structural Engineering · Design"
      accentColor={AMBER}
      inputs={[
        {
          key: "failureStrength",
          label: "Failure/Yield Strength",
          unit: "MPa",
          defaultValue: 500,
          min: 0,
        },
...
function BeamBendingTool() {
  return (
    <ToolShell
      ...
      description="Cantilever beam stress and deflection under tip load"
      domain="Structural Mechanics · Beam Theory"
      accentColor={AMBER}
      inputs={[
        ...
        { key: "height", label: "Cross-section Height", unit: "m", defaultValue: 0.1, min: 0.001 },
        {
          ...
          defaultValue: 200,
          min: 0.1,
          helpText: "Steel ≈ 200 GPa, Aluminum ≈ 70 GPa",
        },
...
function ShaftTorsionTool() {
  return (
    <ToolShell
      ...
      description="Calculate shear stress and angle of twist in a solid circular shaft"
      domain="Machine Design · Power Transmission"
      accentColor={AMBER}
      inputs={[
...
function PowerTorqueTool() {
  return (
    <ToolShell
      name="Power / Torque / RPM Calculator"
      description="Convert between power, torque, and rotational speed"
      domain="Machine Design · Power Transmission"
      accentColor={AMBER}
      inputs={[
...
function ThermalConductionTool() {
  return (
    <ToolShell
      ...
      description="Calculate heat transfer through a flat wall using Fourier's law"
      domain="Heat Transfer · Thermal Engineering"
      accentColor={AMBER}
      inputs={[
        {
          key: "conductivity",
          ...
          defaultValue: 50,
          min: 0.001,
          helpText: "Steel ≈ 50, Aluminum ≈ 205, Air ≈ 0.026",
        },
...
function ConvectionTool() {
  return (
    <ToolShell
      name="Convective Heat Transfer Calculator"
      description="Calculate convective heat transfer using Newton's law of cooling"
      domain="Heat Transfer · Thermal Engineering"
      accentColor={AMBER}
      inputs={[
        {
          ...
          defaultValue: 25,
          min: 0.01,
          helpText: "Free conv air ≈ 5-25, forced ≈ 25-250, water ≈ 500-10000",
        },
...
function RadiationTool() {
  return (
    <ToolShell
      name="Thermal Radiation Calculator"
      description="Calculate radiative heat transfer using the Stefan-Boltzmann law"
      domain="Heat Transfer · Radiative Transfer"
      accentColor={AMBER}
      inputs={[
        {
          key: "emissivity",
          ...
          max: 1,
          step: 0.01,
          helpText: "Black body = 1.0, polished metal ≈ 0.05-0.2",
        },
        ...
        {
          key: "tempCold",
          label: "Surroundings Temperature",
          unit: "K",
          defaultValue: 300,
          min: 0,
        },
...
function LMTDTool() {
  return (
    <ToolShell
      name="Heat Exchanger LMTD Calculator"
      description="Calculate logarithmic mean temperature difference for heat exchanger design"
      domain="Heat Transfer · Heat Exchanger Design"
      accentColor={AMBER}
      inputs={[
...
function ReynoldsPipeTool() {
  return (
    <ToolShell
      name="Reynolds Number Calculator (Pipe)"
      description="Calculate Reynolds number for internal pipe flow and determine friction factor"
      domain="Fluid Mechanics · Pipe Flow"
      accentColor={AMBER}
      inputs={[
        ...
        { key: "diameter", label: "Pipe Diameter", unit: "m", defaultValue: 0.05, min: 0.001 },
        {
          ...
          defaultValue: 998,
          min: 0.01,
          helpText: "Water ≈ 998, Air ≈ 1.225",
        },
        {
          key: "viscosity",
          label: "Dynamic Viscosity",
          unit: "Pa·s",
          defaultValue: 1.002e-3,
          min: 1e-8,
          helpText: "Water ≈ 1.002×10⁻³, Air ≈ 1.789×10⁻⁵",
        },
      ]}
      ...
      assumptions={[
        ...
        "Laminar < 2300 < Transitional < 4000 < Turbulent",
      ]}
      onCalculate={(v) => {
...
function BernoulliTool() {
  return (
    <ToolShell
      name="Bernoulli Equation Analyzer"
      description="Analyze pressure-velocity-elevation relationships along a streamline"
      domain="Fluid Mechanics · Incompressible Flow"
      accentColor={AMBER}
      inputs={[
        ...
        { key: "z1", label: "Elevation at Point 1", unit: "m", defaultValue: 5 },
        {
          ...
          defaultValue: 5.0,
          min: 0,
          helpText: "Provide to solve for P₂",
        },
...
function PipeDropTool() {
  return (
    <ToolShell
      ...
      description="Calculate friction-based pressure drop using Darcy-Weisbach with Swamee-Jain friction factor"
      domain="Fluid Mechanics · Pipe Systems"
      accentColor={AMBER}
      inputs={[
        ...
        { key: "viscosity", label: "Dynamic Viscosity", unit: "Pa·s", defaultValue: 1.002e-3 },
        {
          ...
          min: 0,
          step: 0.00001,
          helpText: "Commercial steel ≈ 0.045mm, PVC ≈ 0.0015mm",
        },
      ]}
      equations={[
        "ΔP = f · (L/D) · (ρV²/2)",
        "h_L = ΔP / (ρg)",
        "f from Swamee-Jain (explicit Colebrook approximation)",
      ]}
      assumptions={[
        "Fully developed flow",
        "Circular pipe",
        "No minor losses (valves, bends)",
        "Steady-state flow",
      ]}
      onCalculate={(v) => {
        const r = computePipePressureDrop(
          v.velocity,
          v.diameter,
          v.length,
          v.density,
...
function PumpPowerTool() {
  return (
    <ToolShell
      ...
      description="Calculate required pump power from flow rate, head, and efficiency"
      domain="Fluid Mechanics · Pump Systems"
      accentColor={AMBER}
      inputs={[
        {
          key: "flowRate",
      ...
      assumptions={[
        ...
        "Includes only hydraulic power (no motor losses)",
      ]}
      onCalculate={(v) => {
...
function PumpPerformanceTool() {
  return (
    <ToolShell
      name="Centrifugal Pump Performance Tool"
      description="Find operating point from pump and system curves"
      domain="Fluid Mechanics · Pump Systems"
      status="beta"
      accentColor={AMBER}
      inputs={[
        ...
        {
          key: "frictionK",
          label: "System Friction Coefficient",
          unit: "s²/m⁵",
          defaultValue: 5000,
          min: 0,
          helpText: "K where H_friction = K·Q²",
        },
        { key: "density", label: "Fluid Density", unit: "kg/m³", defaultValue: 998 },
        {
          key: "efficiency",
      ...
      assumptions={[
        "Quadratic pump curve approximation",
        "System curve includes static head + friction",
        "Constant pump efficiency",
      ]}
      onCalculate={(v) => {
        const r = computeCentrifugalPumpPerformance(
          v.shutoffHead,
          v.maxFlow,
          v.staticHead,
          v.frictionK,
          ...
          results: [
            {
              ...
              value: r.operatingFlowRate * 1000,
              unit: "L/s",
              highlight: true,
            },
...
function NaturalFreqTool() {
  return (
    <ToolShell
      ...
      description="Calculate undamped natural frequency of a single degree-of-freedom system"
      domain="Vibrations · Dynamics"
      accentColor={AMBER}
      inputs={[
...
function SpringTool() {
  return (
    <ToolShell
      ...
      description="Calculate force, deflection, and stored energy for a linear spring"
      domain="Machine Design · Energy Storage"
      accentColor={AMBER}
      inputs={[
        {
          key: "springConstant",
        ...
        {
          key: "mass",
          label: "Attached Mass (optional)",
          unit: "kg",
          defaultValue: 2,
          min: 0,
          helpText: "For natural frequency calculation",
        },
      ]}
      equations={["F = kx", "E = ½kx²", "f_n = √(k/m) / (2π)"]}
      assumptions={["Hooke's law (linear elastic)", "No damping or friction", "Static equilibrium"]}
      onCalculate={(v) => {
        const r = computeSpringDesign(
          v.springConstant,
          v.load,
          undefined,
          v.mass > 0 ? v.mass : undefined,
        );
        if (!r) return null;
        return {
          results: [
...
function GearRatioTool() {
  return (
    <ToolShell
      ...
      description="Calculate gear ratio, output speed, and torque for a gear pair"
      domain="Machine Design · Power Transmission"
      accentColor={AMBER}
      inputs={[
        {
          key: "inputTeeth",
          label: "Input Gear Teeth",
          unit: "—",
          defaultValue: 20,
          min: 1,
          step: 1,
      ...
      assumptions={[
        "Ideal gear teeth profile",
        "Constant mesh efficiency",
        "No backlash effects",
        "Single gear stage",
      ]}
      onCalculate={(v) => {
        const r = computeGearRatio(
          v.inputTeeth,
          v.outputTeeth,
          v.inputRPM,
          v.inputTorque,
        ...
        return {
          results: [
            ...
            {
              label: "Type",
              value: r.speedReduction ? "Speed Reduction" : "Speed Increase",
              unit: "",
            },
          ],
        };
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-white/50">
          Compare aerospace and structural materials by mechanical and thermal properties
        </p>
      ...
      <div className="bg-[#0A1020] border border-white/8 rounded-lg p-3">
        <p className="text-[10px] text-amber-400/60 flex items-center gap-1.5">
          ...
          Data source: Standard material handbooks (MIL-HDBK-5, MMPDS). Values are typical — consult
          manufacturer datasheets for specific alloy/temper/condition.
        </p>
      </div>
    </div>
  );

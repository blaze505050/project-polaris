...
const FALLBACK_LIBRARY: ResearchPaper[] = [
  {
    ...
    abstract:
      "Comprehensive experimental and theoretical summary of NACA 4-digit, 5-digit, and 6-series airfoil aerodynamic performance parameters across subcritical Reynolds numbers.",
  ...
  },
  {
    ...
    abstract:
      "Derivation of the ideal rocket equation relating velocity change (delta-v) to effective exhaust velocity and initial-to-final mass ratio.",
  ...
  },
  {
    ...
    abstract:
      "Standard authoritative textbook covering inviscid incompressible flow, thin airfoil theory, oblique shocks, Prandtl-Glauert compressibility, and viscous boundary layer theory.",
  ...
  },
  {
    ...
    journal: "McGraw-Hill Education",
    abstract:
      "Core reference for static failure theories, fatigue strength, beam deflection, shaft torsion, gear geometry, and mechanical component sizing.",
  ...
  },
  {
    ...
    abstract:
      "Introduction of boundary layer theory, induced drag, and lifting-line theory for 3D finite wings.",
    ...
    try {
      ...
      return data.results.map((item: any) => ({
        ...
        abstract: item.abstract_inverted_index
          ? "Abstract indexed in OpenAlex database."

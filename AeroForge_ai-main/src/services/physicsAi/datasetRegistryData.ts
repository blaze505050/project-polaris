...
export const DATASET_REGISTRY: DatasetCard[] = [
  {
    ...
    variables: ['Velocity Field (u, v)', 'Pressure (p)', 'Turbulent Viscosity (nu_t)', 'Wall Distance', 'Airfoil Profile'],
    ...
    useInAeroForge: 'Training baseline for AeroGraphNet 2D airfoil surface pressure and drag prediction',
    accessMethod: 'Public Open-Access Repository (HuggingFace / INRIA)',
    citation: 'Bonnet, Julien, et al. (2022). AirfRANS: High-Fidelity RANS Dataset for 2D Airfoils. NeurIPS 2022 Datasets Benchmarks Track.',
    verifiedLicense: true,
    description: 'First comprehensive benchmark dataset dedicated to 2D airfoil Reynolds-Averaged Navier-Stokes flow fields across varying angles of attack and Reynolds numbers.',
  ...
  },
  {
    ...
    citation: 'Takamoto, M., et al. (2022). PDEBench: An Extensive Benchmark for Scientific Machine Learning. NeurIPS 2022.',
    verifiedLicense: true,
    description: 'Extensive benchmark suite covering a diverse range of 1D, 2D, and 3D physical systems for training and evaluating neural operators.',
  ...
  },
  {
    ...
    variables: ['Surface Pressure (Cp)', 'Wall Shear Vector', 'Total Pressure Iso-Surfaces', 'Force Coefficients (Cd, Cl)'],
    ...
    citation: 'Indinger, T., et al. (2023). DrivAerML: Open-Source Machine Learning Dataset for Automotive Aerodynamics.',
    verifiedLicense: true,
    description: 'Realistic automotive aerodynamic CFD dataset featuring multiple body styles, underbodies, wheels, and cooling geometries.',
  ...
  },
  {
    ...
    variables: ['Sectional Cl, Cd, Cm', 'Slat/Flap Gap Pressure Distributions', 'Boundary Layer Transition Location'],
    ...
    citation: 'Slotnick, J. P., et al. (2024). NASA High-Lift Prediction Workshop ML Benchmark Data.',
    verifiedLicense: true,
    description: 'NASA benchmark dataset for multi-element high-lift aircraft wings in takeoff and landing configurations.',
  ...
  },
  {
    ...
    variables: ['Mach Number Field', 'Density (rho)', 'Pressure (p)', 'Schlieren Gradient Magnitude'],
    ...
    useInAeroForge: 'Training data for high-speed supersonic shock pattern prediction in Poseidon operator',
    accessMethod: 'ETH Zurich Data Archive',
    citation: 'ETH Zurich Physics AI Group (2024). Poseidon Dataset: High-Speed Fluid Dynamics for Deep Learning.',
    verifiedLicense: true,
    description: 'Large-scale dataset covering shock wave reflections, oblique shocks, and supersonic wedge expansions across Mach 1.2 to 5.0.',
  ...
  },
  {
    ...
    variables: ['Vorticity (omega)', 'Kinetic Energy (k)', 'Dissipation Rate (epsilon)', 'Reynolds Stress Tensor'],
    ...
    verifiedLicense: true,
    description: 'High-resolution DNS turbulence dataset capturing energy cascade across spatial scales from integral length down to Kolmogorov micro-scales.',

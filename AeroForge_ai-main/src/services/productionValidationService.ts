...
export function validateOrbitalMechanics(params: {
  ...
  if (params.eccentricity > 0.8) {
    recommendations.push(
      "High eccentricity detected - verify this is intentional for your mission",
    );
    recommendations.push(
      "Consider using Kepler equation solver for accurate position calculations",
    );
  }

  if (params.inclination > 60) {
    recommendations.push(
      "High inclination orbit - ensure launch site can support this inclination",
    );
  }

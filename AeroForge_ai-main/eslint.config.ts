    ...
    rules: {
      ...
      "no-restricted-syntax": [
        "error",
        {
          ...
          message:
            'ROUTER NOT CONNECTED: The placeholder "<div>Wix Vibe</div>" must be replaced with your actual page component. FIX: 1) Import your page component (e.g., import { HomePage } from "./pages/HomePage"), 2) Replace element: <div>Wix Vibe</div> with element: <HomePage />',
        },
        {
          selector:
